    ...
    try {
        ...
        switch (tool) {
            ...
            case 'pdf-para-pdfa':
                ...
                const gsDefPath = 'PDFA_def.ps'; 
                
                // --- NOVAS FLAGS ADICIONADAS ---
                // -dHaveTransparency=false: Força o "achatamento" (flatten) de qualquer transparência.
                // -dCompatibilityLevel=1.4: Define um nível de compatibilidade que ajuda no achatamento.
                const command = `
